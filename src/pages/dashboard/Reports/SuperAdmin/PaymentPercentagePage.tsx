...
const buildColumns = (
  ...
  {
    name: t("status"),
    cell: (row: PaymentPctRow) => <StatusBadge status={row.status} t={t} />,
    center: true,
  },
];
...
const PaymentPercentagePage = () => {
  ...
  const STATUS_OPTIONS = [
    ...
    { value: "FULLY_PAID", label: t("fullyPaid") },
  ...
  return (
    <>
      <DashboardPageTitle text={t("paymentPercentageReport")} />
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                <p className="text-xs text-gray-400 font-medium mb-1">
                  {t("averageCollectionPercentSign")}
                </p>
