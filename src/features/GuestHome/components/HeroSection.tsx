  ...
  return (
    <div className="bg-primary">
      <div className="container flex flex-col-reverse md:flex-row pt-10 max-xl:pb-10 justify-between items-center md:items-start">
        ...
        >
          <motion.h1
            className="text-text-first text-2xl md:text-2xl font-second font-medium leading-snug pt-3 pb-2"
          ...
          >
            <DefaultButton
              ...
              text={t("subscribe")}
              type="button"
              moreStyle="px-12 md:px-16 text-lg md:text-xl mt-10 md:mt-10 !shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]"
            />
          </motion.div>
        </motion.div>
