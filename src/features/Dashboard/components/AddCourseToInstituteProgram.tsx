...
const AddCourseToInstituteProgram = ({
  reviewModalOpen,
  setReviewModalOpen,
  programId,
  ...
  const { mutate, isLoading } = useMutation({
    ...
    onSuccess: () => {
      Swal.fire({
        icon: "success",
        title: t("courseAssigned"),
        text: t("courseSuccessfullyAddedToProgram"),
      });
...
export default AddCourseToInstituteProgram;
