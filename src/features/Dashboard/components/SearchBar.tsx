...
const SearchBar = ({
  ...
  return (
    <div className={`relative ${className} w-full md:max-w-2/5`} ref={inputRef}>
      <div className="relative text-gray-600 flex-1 ">
        <input
          className="bg-[#F6F6F6] py-5 border-[#8A8A8A] w-full h-9 px-2 ps-10 rounded-xl text-sm focus:outline-none"
          type="search"
      ...
      {/* Dropdown */}
      {showDropdown && (
        <div className="absolute z-50 bg-white border border-gray-300 rounded-md w-full md:max-w-2/5 shadow-sm">
