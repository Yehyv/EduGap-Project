      ...
      <div className="flex flex-col md:flex-row gap-2 items-start">
        ...
        <div className="flex flex-col flex-1 min-h-full">
          ...
          <div>
            ...
            <div className="mb-4">
              يقوم بدور مهم في الشرق الأوسط، من خلال رصد وتحليل الاتجاهات
              المختلفة في مجالات الأعمال التجارية والمشروعات الناشئة والسفر
              والإعلام. وقد شارك فادي في دورات تدريبية ومؤتمرات دولية في مصر،
              وتونس، والمملكة العربية السعودية، والكويت، وكينيا، وإيطاليا،
              وغيرها من الدول
            </div>
          </div>

          {/* Stats */}
          <div className="bg-[#F1EFEF] mt-auto flex flex-col sm:flex-row justify-between text-base px-4 py-2 rounded-lg shadow-sm gap-4">
