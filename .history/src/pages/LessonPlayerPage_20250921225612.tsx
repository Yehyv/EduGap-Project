    ...
    <div className="flex flex-col-reverse gap-6 m-6 lg:m-14 lg:flex-row">
      ...
      <div className="w-full lg:w-[80%]">
        ...
        <div className="flex mt-4">
          <div className="w-1/2 rounded-s-2xl shadow-2xl border-e border-[#939393] py-3 bg-[#F8F8F8] text-secondary text-center">
            المحاضرة التالية 1.24
          </div>
          <div className="w-1/2 rounded-e-2xl py-3 bg-[#F8F8F8] text-secondary text-center">
