          ...
          <div className="my-10">
            ...
            {activeTab === "attachments" && (
              <div className="in-h-[400px]">
                ...
                <div className="mb-5">
                  <div className="flex gap-2 border border-[#D6D6D6] rounded-xl p-3 items-center">
                    <AttachementIcon />
                    <div className="w-full">
                      <span>قالب استراتيجية التسويق بالذكاء الاصطناعي.pdf</span>
                      <span className="text-[#797979] text-sm">2.3 م ب</span>
                    </div>
                    <DownloadIcon />
                  </div>
                </div>
