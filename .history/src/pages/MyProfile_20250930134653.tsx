      ...
      <div className="flex gap-6">
        ...
        <div className="w-1/4 h-full">
          ...
          <div className="flex items-center gap-2 mt-4">
            {" "}
            <span className="text-yellow-400">4.8</span> <StarIcon />{" "}
        ...
        <div className="flex flex-col">
          ...
          <p className="my-4">
            ...
            <ExpandableText
              limit={2}
              text=" يقوم بدور مهم في الشرق الأوسط، من خلال رصد وتحليل الاتجاهات المختلفة في مجالات الأعمال التجارية والمشروعات الناشئة والسفر والإعلام. وقد شارك فادي في دورات تدريبية ومؤتمرات دولية في مصر، وتونس، والمملكة العربية السعودية، والكويت، وكينيا، وإيطاليا، وغيرها من الدول يقوم بدور مهم في الشرق الأوسط، من خلال رصد وتحليل الاتجاهات المختلفة في مجالات الأعمال التجارية والمشروعات الناشئة والسفر والإعلام. وقد شارك فادي في دورات تدريبية ومؤتمرات دولية في مصر، وتونس، والمملكة العربية السعودية، والكويت، وكينيا، وإيطاليا، وغيرها من الدول يقوم بدور مهم في الشرق الأوسط، من خلال رصد وتحليل الاتجاهات المختلفة في مجالات الأعمال التجارية والمشروعات الناشئة والسفر والإعلام. وقد شارك فادي في دورات تدريبية ومؤتمرات دولية في مصر، وتونس، والمملكة العربية السعودية، والكويت، وكينيا، وإيطاليا، وغيرها من الدول"
            />{" "}
          </p>{" "}
          <div className="bg-[#F1EFEF] flex justify-between text-lg mt-auto px-4 py-0 rounded-lg">
            ...
            <div className="center gap-2">
              {" "}
              <EyeIcon className="w-7" /> <div>المشاهدات : 1,762</div>{" "}
            </div>{" "}
            <div className="center gap-2">
              {" "}
              <PlayVideoIcon className="w-6" /> <div>الدورات : 2</div>{" "}
            </div>{" "}
            <div className="center gap-2">
              {" "}
              <StudentsIcon className="w-7" /> <div>المتعلمين : 985</div>{" "}
            </div>{" "}
          </div>{" "}
        </div>{" "}
      </div>{" "}
