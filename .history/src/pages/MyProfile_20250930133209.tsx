        ...
        <div className="flex-1 flex flex-col">
          ...
          <ExpandableText
            ...
            text=" يقوم بدور مهم في الشرق الأوسط، من خلال رصد وتحليل الاتجاهات المختلفة
              ...
              العربية السعودية، والكويت، وكينيا، وإيطاليا، وغيرها من الدول لسفر والإعلام. وقد
              شارك فادي في دورات تدريبية ومؤتمرات دولية في مصر، وتونس، والمملكة
              العربية السعودية، والكويت، وكينيا، وإيطاليا، وغيرها من الدول"
          />

          {/* Stats */}
          <div className="bg-[#F1EFEF] mt-auto flex flex-col sm:flex-row justify-between text-base mt-6 px-4 py-1 rounded-lg shadow-sm gap-4">
            ...
            <div className="flex items-center gap-2">
              <StudentsIcon className="w-7 h-7" />
