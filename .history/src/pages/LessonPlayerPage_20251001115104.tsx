    ...
    <div>
      ...
      <div className="flex justify-start flex-col-reverse gap-6 m-6 lg:mx-14 lg:flex-row">
        ...
        <div className="w-full lg:w-[80%]">
          ...
          <div className="flex mt-4 bg-[#F5F5F5]">
            <div className="w-1/2 rounded-s-xl cursor-pointer border-e border-[#939393] py-3 bg-[#F8F8F8] text-center">
              المحاضرة التالية 1.24
            </div>
            <div className="w-1/2 rounded-e-xl py-3 cursor-pointer bg-white text-center">
