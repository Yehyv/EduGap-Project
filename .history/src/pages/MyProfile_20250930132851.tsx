  ...
  return (
    <div className="container my-10">
      <div className="flex flex-col md:flex-row gap-4 items-start">
        ...
        <div className="w-full md:w-[15%] flex flex-col items-center md:items-start">
          <img
            src={profileImage}
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Stats */}
          <div className="bg-[#F1EFEF] flex flex-col sm:flex-row justify-between text-base mt-6 px-4 py-3 rounded-lg shadow-sm gap-4">
