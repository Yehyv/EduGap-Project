            ...
            {activeTab === "notes" && (
              <div className="min-h-[400px]">
                ...
                <div className="flex gap-10 mt-10">
                  <div className="bg-[#F3FEFF] min-h-[200px] w-1/2 rounded-xl border border-[#9E9C9C]">
                    النوت الخاصة باليوزر
                  </div>
                  <div className="bg-[#F3FEFF] min-h-[200px] w-1/2 rounded-xl border border-[#9E9C9C]"></div>
                </div>
              </div>
            )}
            {activeTab === "questions" && (
