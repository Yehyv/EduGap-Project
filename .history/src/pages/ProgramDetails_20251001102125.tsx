...
const ProgramDetails = () => {
  ...
  return (
    <div>
      <div className="relative bg-gradient-to-b from-primary to-[white] py-10">
        <IconsGroup className="absolute object-contain start-0 end-0 top-0 bottom-0 w-full h-full" />
