  ...
  return (
    <div className="container my-10">
      ...
      <div className="flex justify-between">
        <div className="flex items-center gap-1 mt-4 w-[20%] gap-4">
        ...
        {/* Stats */}
        <div className="bg-[#F1EFEF] w-full flex flex-col sm:flex-row justify-between text-base px-4 py-2 rounded-lg shadow-sm gap-4 mt-auto">
