    ...
    <div className="container my-10">
      <div className="flex gap-6">
        ...
        <div className="flex flex-col">
          ...
          <div className="bg-[#F1EFEF] flex justify-between text-lg mt-auto px-4 py-2 rounded-lg">
            <div className="center gap-2">
              <EyeIcon className="h-7" />
              <div>المشاهدات : 1,762</div>
            </div>
            <div className="center gap-2">
              <PlayVideoIcon className="w-5" />
              <div>الدورات : 2</div>
            </div>
            <div className="center gap-2">المتعلمين : 985</div>
          </div>
        </div>
      </div>
    </div>
