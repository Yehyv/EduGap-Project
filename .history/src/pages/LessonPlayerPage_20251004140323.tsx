            ...
            {activeTab === "notes" && (
              <div className="min-h-[400px]">
                ...
                <div className="flex gap-10 mt-10">
                  <div className="w-1/2">
                    <h5>ملاحظة 3</h5>
                    <h5>1.2 تعريف الذكاء الاصطناعي</h5>
                    <div className="bg-[#F3FEFF] min-h-[200px] rounded-xl border border-[#9E9C9C] p-2">
                      النوت الخاصة باليوزر
                    </div>
                  </div>
                  <div className="bg-[#F3FEFF] min-h-[200px] w-1/2 rounded-xl border border-[#9E9C9C] p-2">
                    النوت الخاصة باليوزر
                  </div>
                </div>
              </div>
