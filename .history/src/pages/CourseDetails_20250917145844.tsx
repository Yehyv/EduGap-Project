...
const faqs = [
  {
    ...
    answer: [
      "تعريف الذكاء الاصناعي",
      "هو محاكاة سلوك العقل البشري باستخدام الخوارزميات.",
    ],
  },
  {
    ...
    answer: [
      ...
      "It allows rapid UI development with predefined classes.",
    ],
  },
];
  ...
  return (
    <div className="flex flex-col md:flex-row m-6 md:m-14 gap-6">
      <div className="w-full md:w-[80%]">
        ...
        <div className="border-b-1 py-5 border-[#575757]">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-center gap-2">
              <CheckIcon className="w-6 h-6" />
              <span>
                تستخدم ChatGPT في الحملات التسويقية لزيادة التفاعل والتأثير،
                وتنشئ محتوى تسويقي مبتكر باستخدام تقنيات الذكاء الاصطناعي.
              </span>
            </li>
            <li className="flex items-center gap-2">
              <CheckIcon className="w-6 h-6" />
              <span>
                تستخدم ChatGPT لإنشاء صور احترافية وجذابة لاستخدامها في الحملات
                التسويقية. كما ستتعلم أن تنشئ الصور باستخدام الأدوات مثل: Bing،
                وAdobe Firefly، وMicrosoft Designer.
              </span>
            </li>
            <li className="flex items-center gap-2">
              <CheckIcon className="w-6 h-6" />
              <span>
                تستخدم تطبيق Capcut لتحرير وتحسين الفيديوهات التسويقية، مما يسهم
                في تقليل الميزانية المخصصة للتسويق والحصول على فيديوهات احترافية
                تعزز تفاعل الجمهور المستهدف.
              </span>
            </li>
          </ul>
        </div>
