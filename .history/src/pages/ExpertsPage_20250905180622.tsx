...
import { getAllExpertsList } from "@/shared/services/sharedApis";
...
const ExpertsPage = () => {
  ...
  return (
    <div className="container my-10">
      ...
      <ScrollToTop />
      {isLoading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 justify-center xl:grid-cols-5 gap-2">
