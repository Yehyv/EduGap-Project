...
const CourseVideo = lazy(
  () => import("@/shared/components/EduGap/CourseVideo")
);
const CourseContentCard = lazy(
  () => import("@/features/CourseDetails/components/CourseContentCard")
);
const CommentsSection = lazy(
  () => import("@/shared/components/ui/CommentsSections")
);
      ...
      <div className="flex justify-start flex-col-reverse gap-6 m-6 lg:mx-14 lg:flex-row">
        ...
        <div className="w-full lg:w-[80%]">
          ...
          <div className="flex mt-4 gap-2 bg-[#F5F5F5] p-2 rounded-3xl">
            <div className="w-1/2 rounded-3xl py-1 cursor-pointer bg-white text-center">
              التعليقات
            </div>
          ...
          <div className="my-10">
            ...
            <Suspense
              fallback={<div className="text-center">Loading comments...</div>}
            >
              <CommentsSection />
            </Suspense>
          </div>
        ...
        {/* Sidebar */}
        <Suspense
          fallback={<div className="text-center">Loading sidebar...</div>}
        >
          <CourseContentCard />
        </Suspense>
      </div>
