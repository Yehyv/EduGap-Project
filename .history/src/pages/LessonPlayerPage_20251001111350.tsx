...
const LessonPlayerPage = () => {
  ...
  return (
    <div>
      <ScrollToTop />
      <div className="flex justify-between items-center py-2 lg:mx-14">
        {/* Progress Section */}
      ...
      <div className="flex justify-start flex-col-reverse gap-6 m-6 lg:mx-14 lg:flex-row">
        ...
        <div className="w-full lg:w-[80%]">
          ...
          <div className="flex justify-between py-2">
            ...
            <button className="bg-[#F5F5F5] rounded-3xl text-sm px-6 py-2 text-secondary">
              إضافة الي الدروس الهامة
            </button>
            <div></div>
          </div>
