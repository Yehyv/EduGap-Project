  ...
  return (
    <div>
      <div className="relative bg-gradient-to-b from-primary to-[white] py-10 pb-16">
        ...
        <div className="container flex justify-between max-md:flex-col-reverse max-md:gap-4 max-md:items-center">
          <div className="w-1/2">
          ...
          <div className="relative w-[200px] h-[200px]">
            <div className="absolute w-[200px] h-[200px] start-6 bg-[#FCB737] rounded-2xl -rotate-[30deg]" />
