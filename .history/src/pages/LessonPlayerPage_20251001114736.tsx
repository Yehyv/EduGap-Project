        ...
        <div className="w-full lg:w-[80%]">
          ...
          <div className="flex justify-between py-2">
            ...
            <div className="flex gap-2">
              <button className="bg-[#F5F5F5] rounded-3xl text-sm px-6 py-2 text-secondary center gap-2">
                <FavStarIcon />
                <div>إضافة الي الدروس الهامة</div>
              </button>
              <div className="bg-[#F5F5F5] rounded-3xl flex items-center text-secondary gap-3 p-2">
                <div className="center gap-2 border-e px-3 cursor-pointer">
                  {/* <div>22</div> */}
                  <DisLikeIcon />
                </div>
          ...
          <div className="flex mt-4">
            <div className="w-1/2 rounded-s-xl cursor-pointer border-e border-[#939393] py-3 bg-[#F8F8F8] text-secondary text-center">
              المحاضرة التالية 1.24
            </div>
            <div className="w-1/2 rounded-e-xl py-3 cursor-pointer bg-[#F8F8F8] text-secondary text-center">
