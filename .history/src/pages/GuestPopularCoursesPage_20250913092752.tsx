...
const GuestPopularCoursesPage = () => {
  ...
  const { data, isLoading, error } = useQuery<CoursesResponse>({
    ...
    queryFn: () => getAllGuestPopularCourses(page.toString(), RESULTS_PER_PAGE),
  });
  ...
  return (
    <div className="mb-5 mt-10 container">
      ...
      {isLoading ? (
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 max-h-[300px]">
