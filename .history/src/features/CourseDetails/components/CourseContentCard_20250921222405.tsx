...
const faqs = [
  ...
  {
    question: "استخدام الذكاء الاصطناعي في انتاج مقاطع",
    answer: ["فهم ما هو الذكاء الاصناعي", "أهمية الذكاء الاصناعي"],
  },
];
const CourseContentCard = () => {
  ...
  return (
    <div className="w-full xl:sticky overflow-hidden top-16 lg:w-[30%] bg-neutral-100 rounded-xl px-6 py-5 min-h-[300px] min-lg:h-[400px]">
