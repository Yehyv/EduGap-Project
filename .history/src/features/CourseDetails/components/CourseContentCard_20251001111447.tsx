...
const CourseContentCard = () => {
  ...
  return (
    <div className="w-full xl:sticky shadow-custom overflow-auto top-16 lg:w-[30%] bg-neutral-100 rounded-xl px-6 py-5 min-lg:min-h-full min-lg:h-[400px]">
      <h5 className="text-lg font-semibold mb-4">{t("course_content")}</h5>
