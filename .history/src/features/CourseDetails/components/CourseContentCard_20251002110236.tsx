...
const CourseContentCard = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-2 w-full lg:w-[30%] min-lg:min-h-full min-lg:h-[400px]">
      ...
      <h5 className="shadow-custom overflow-auto top-16 rounded-xl p-5 font-semibold">
        الدروس الهامة
      </h5>
      <h5 className="shadow-custom overflow-auto top-16 rounded-xl p-5 font-semibold">
        ملاحظاتي
