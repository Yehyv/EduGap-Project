...
const CourseDetails = ({ isAuth }: { isAuth: boolean }) => {
  const { t } = useLanguage();
  ...
  return (
    <div className="flex flex-col-reverse gap-6 m-6 lg:m-14 lg:flex-row">
      ...
      <div className="w-full lg:w-[80%]">
        ...
        <section className="my-5">
          ...
          <ExpandableText
            limit={3}
            text={
              "يُعد استخدام الذكاء الاصطناعي في التسويق بمثابة تغيير جذري في قواعد اللعبة، حيث أحدث ثورة في كيفية تواصل الشركات مع جماهيرها. تم تصميم هذه الدورة الديناميكية بدقة لتزويد المسوقين ورواد الأعمال وصانعي المحتوى بالمعرفة والمهارات اللازمة لتسخير الإمكانات الكاملة لأدوات الذكاء الاصطناعي في تشكيل حملات تسويقية فعالة ومؤثرة. سنتناول في هذه الدورة أسس الذكاء الاصطناعي في التسويق وكيف يمكن تطبيقها بشكل فع يُعد استخدام الذكاء الاصطناعي في التسويق بمثابة تغيير جذري في قواعد اللعبة، حيث أحدث ثورة في كيفية تواصل الشركات مع جماهيرها. تم تصميم هذه الدورة الديناميكية بدقة لتزويد المسوقين ورواد الأعمال وصانعي المحتوى بالمعرفة والمهارات اللازمة لتسخير الإمكانات الكاملة لأدوات الذكاء الاصطناعي في تشكيل حملات تسويقية فعالة ومؤثرة. سنتناول في هذه الدورة أسس الذكاء الاصطناعي في التسويق وكيف يمكن تطبيقها بشكل فعال. يُعد استخدام الذكاء الاصطناعي في التسويق بمثابة تغيير جذري في قواعد اللعبة، حيث أحدث ثورة في كيفية تواصل الشركات مع جماهيرها. تم تصميم هذه الدورة الديناميكية بدقة لتزويد المسوقين ورواد الأعمال وصانعي المحتوى بالمعرفة والمهارات اللازمة لتسخير الإمكانات الكاملة لأدوات الذكاء الاصطناعي في تشكيل حملات تسويقية فعالة ومؤثرة. سنتناول في هذه الدورة أسس الذكاء الاصطناعي في التسويق وكيف يمكن تطبيقها بشكل فعال.ال."
            }
          />
        </section>
      ...
      {/* Sidebar */}
      <StickyCourseSummaryCard isAuth={isAuth} />
    </div>
  );
};
