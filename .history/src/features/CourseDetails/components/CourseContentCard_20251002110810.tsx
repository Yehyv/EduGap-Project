...
import StarIcon from "@/assets/svgs/FavStarIcon.svg?react";
const faqs = [
  {
...
const CourseContentCard = () => {
  ...
  return (
    <div className="w-full lg:w-[30%] min-lg:min-h-full min-lg:h-[400px]">
      ...
      <h5 className="mt-2 flex gap-2 shadow-custom overflow-auto top-16 rounded-xl px-5 py-2 font-semibold">
        <StarIcon className="inline-block" />
        <span>الدروس الهامة</span>
      </h5>
      <h5 className="mt-2 shadow-custom overflow-auto top-16 rounded-xl px-5 py-2 font-semibold">
        ملاحظاتي
      </h5>
      <h5 className="mt-2  shadow-custom overflow-auto top-16 rounded-xl px-5 py-2 font-semibold">
        مرفقات الدورة
