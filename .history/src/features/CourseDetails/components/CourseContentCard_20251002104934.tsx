...
const CourseContentCard = () => {
  ...
  return (
    <div className="w-full lg:w-[30%]">
      <div className="shadow-custom overflow-auto top-16 rounded-xl py-5 min-lg:min-h-full min-lg:h-[400px]">
      ...
      {/* <div className="shadow-custom overflow-auto top-16 rounded-xl py-5 min-lg:min-h-full min-lg:h-[400px]"></div> */}
    </div>
  );
};
