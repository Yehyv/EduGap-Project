  ...
  return (
    <div className="container my-5">
      ...
      >
        {/* Video Section */}
        <div
          className={` relative w-full h-[300px] md:min-h-[350px] md:col-span-3`}
        >
          {!isOnline ? (
        ...
        <div className="md:col-span-2 px-6 py-6 flex flex-col">
          ...
          <div className="flex gap-4 items-center my-5">
            ...
            <div>
              <h5 className="font-semibold">Ahmed</h5>
              <h6 className="text-[#575757]">خبير تسويق</h6>
            </div>
          </div>

          <p className="text-gray-600 mb-5 line-clamp-3" title={description}>
            {description}
          </p>
