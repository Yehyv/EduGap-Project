  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        />
        <div className="absolute -bottom-[20px] w-[90%] h-[40px] bg-[#DEF4FF] left-1/2 -translate-x-1/2 rounded-lg text-center text-secondary font-bold text-sm p-1 shadow-custom">
          تكنولوجيا الذكاء الاصطناعي
        </div>
      </div>

      {/* Content Section */}
      <div className="p-2 flex-1 text-sm px-6 mt-5">
