  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        />
        <div className="absolute -bottom-[10px] w-[90%] h-[30px] bg-[#DEF4FF] left-1/2 -translate-x-1/2 rounded-lg text-center text-secondary font-bold text-sm p-1 shadow-custom">
