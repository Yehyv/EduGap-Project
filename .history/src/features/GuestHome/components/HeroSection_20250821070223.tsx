    ...
    <div className="bg-primary">
      <div className="container flex">
        ...
        <div className="relative w-full">
          <div className="absolute end-0 top-0 w-[280px] h-[280px] bg-[#E8ECFF] rounded-full">
            <div className="absolute start-10 bottom-10 w-[200px] h-[200px] bg-[#E0DEDE] rounded-full"></div>
          </div>
          <img
            className="absolute end-9 top-8 w-[240px] h-[240px] z-40 "
            src={HeroImage}
            alt=""
          ></img>
        </div>
