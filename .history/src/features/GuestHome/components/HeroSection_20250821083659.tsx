    ...
    <div className="bg-primary">
      <div className="container flex pt-10">
        <div className="w-full">
          <h1 className="text-text-first font-second font-medium leading-snug pt-6 pb-3">
          ...
          <div className="text-center">
            <DefaultButton
              ...
              text="اشترك الأن"
              type="button"
              moreStyle="px-16 text-xl shadow mt-16"
            />
          </div>
        </div>
        <div className="w-1/3">
          <img className="ms-auto" src={HeroSectionImage}></img>
        </div>
      </div>
    </div>
  );
