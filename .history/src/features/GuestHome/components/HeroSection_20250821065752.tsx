    ...
    <div className="bg-primary">
      <div className="container flex">
        ...
        <div className="relative w-full">
          <div className="absolute end-0 top-0 w-[280px] h-[280px] bg-[#E8ECFF] rounded-full"></div>
          <div className="absolute end-16 top-16 w-[200px] h-[200px] bg-[#E0DEDE] rounded-full"></div>
          <div className="absolute end-16 top-16 w-[200px] h-[200px] z-40 ">
            <img src="../../../assets/imgs/HeroSectionImage.png" alt=""></img>
          </div>
        </div>
      </div>
    </div>
