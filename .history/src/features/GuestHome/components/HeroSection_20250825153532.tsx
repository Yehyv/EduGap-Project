...
const HeroSection = () => {
  return (
    <div className="bg-primary">
      <div className="container flex pt-10 justify-between">
        <div className="w-full max-w-[680px]">
          <h1 className="text-text-first text-3xl font-second font-medium leading-snug pt-6 pb-3">
          ...
          <p className="text-text-second font-second font-semibold">
          ...
          <div className="text-center">
            <DefaultButton
              ...
              text="اشترك الأن"
              type="button"
              moreStyle="px-16 text-xl mt-16 !shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]"
            />
          </div>
        </div>
        <div className="w-[30%]">
