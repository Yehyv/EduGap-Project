...
const HeroSection = () => {
  ...
  return (
    <div className="bg-primary">
      <div className="container flex flex-col-reverse md:flex-row pt-20 max-xl:pb-10 justify-between items-center md:items-start">
        {/* Text Section */}
        <div className="w-full md:max-w-[680px] text-center md:text-start">
          ...
          <div className="center text-center md:text-start">
            <DefaultButton
              ...
              text="اشترك الأن"
              type="button"
              moreStyle="px-12 md:px-16 text-lg md:text-xl my-10 md:mt-16 !shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]"
            />
          </div>
        </div>
