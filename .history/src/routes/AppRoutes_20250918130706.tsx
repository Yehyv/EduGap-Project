...
import CourseDetailsPageForGuest from "@/pages/CourseDetailsPageForGuest";
import CourseDetailsPageForUser from "@/pages/CourseDetailsPageForUser";
export default function AppRoutes() {
  return (
    <Routes>
      ...
      >
        <Route
          path="/guest-course-details/:id"
          element={<CourseDetailsPageForGuest />}
        />
      </Route>
      ...
      >
        ...
        <Route
          ...
          element={<CourseDetailsPageForUser />}
        />
      </Route>
