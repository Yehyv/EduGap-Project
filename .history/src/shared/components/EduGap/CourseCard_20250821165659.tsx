...
const CourseCard = ({ course }: { course: CourseTypes }) => {
  return (
    <div
      className="bg-white mx-1 rounded-xl shadow-custom overflow-hidden max-w-[280px] w-full mb-2 mt-2 transition-all duration-300 ease-in-out
  hover:-translate-y-2 "
      dir="auto"
    >
      {/* Image Section */}
      <div className="relative overflow-hidden rounded-xl">
        ...
        <div className="center absolute bottom-0 w-full h-5 bg-primary/80 flex items-center gap-2 px-2">
          <VolumeIcon />
      ...
      <div className="p-2 pt-2">
        ...
        <div className="flex justify-center">
          <DefaultButton
            ...
            onClick={() => {}}
            type="button"
            moreStyle="min-w-[150px] rounded-3xl !py-0"
          />
        </div>
      </div>
    </div>
