...
const CourseCardOverlayDetails = ({ course }: { course: CourseTypes }) => {
  return (
    <div
      className="
    ...
    >
      ...
      {/* What you'll learn */}
      <h6 className="text-sm font-semibold">ماذا ستتعلم</h6>
      <TitileLine className="w-14" />
      <div className="-mt-2 overflow-y-auto max-h-[50%]">
        <ul className="space-y-2 pr-1 text-sm text-gray-700 h-full">
          {[...Array(10)].map((_, i) => (
