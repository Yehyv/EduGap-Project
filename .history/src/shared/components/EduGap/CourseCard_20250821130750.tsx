...
const CourseCard = ({ course }) => {
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden max-w-[300px] w-full">
      <div className="relative overflow-hidden rounded-xl">
        ...
        />
        <MedalIcon className="absolute end-0 top-20" />
        <div className="h-5 w-full bg-primary/80 absolute bottom-0 center gap-2">
          <VolumeIcon />
          <span className="text-secondary text-sm">عالي المستوي</span>
        </div>
      </div>
