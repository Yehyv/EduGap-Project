            ...
            {data?.map((courseData, idx) => (
              <>
                ...
                <CourseCard
                  key={idx}
                  course={{
                    name: courseData.content.translations[0].name,
                    levelName: courseData.content.level,
                    image: courseData.content.image,
                    completedLessonsCount:
                      courseData.content.completedLessonsCount,
                    lessonsCount: courseData.content.lessonsCount,
                    educators: courseData.content.educators,
                  }}
                />
              </>
            ))}
