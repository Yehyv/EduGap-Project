  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-xl">
        ...
        <div className="absolute bottom-0 w-full h-5 bg-primary flex items-center gap-2 px-2">
          <VolumeIcon />
      ...
      >
        ...
        <div>
          ...
          <ul className="space-y-2 max-h-[120px] overflow-y-auto pr-1 text-sm text-gray-700">
            {[...Array(3)].map((_, i) => (
