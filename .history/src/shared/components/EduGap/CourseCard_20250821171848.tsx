  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <h6 className="text-[14px]">ماذا ستتعلم</h6>
          <TitileLine className="w-14 -mt-2" />
        </div>
        <div>
          <div className="flex">
            <CheckIcon /> تتعرف على أسس الذكاء الاصطناعي في التسويق، وتتعلم
            كيفية استخدام البيانات والتحليلات الذكية في تحسين استراتيجيات
            التسويق.
          </div>
        </div>
      </div>
