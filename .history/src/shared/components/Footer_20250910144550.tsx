...
const Footer = () => {
  ...
  const footerLinks = {
    main: [
      { label: t("footer.main.about"), to: "#" },
      { label: t("footer.main.news"), to: "#" },
      { label: t("footer.main.team"), to: "#" },
      { label: t("footer.main.contact"), to: "#" },
    ],
    discover: [
      { label: t("footer.discover.courses"), to: "#" },
      { label: t("footer.discover.popular"), to: "#" },
      { label: t("footer.discover.plans"), to: "#" },
      { label: t("footer.discover.experts"), to: "#" },
    ],
    business: [{ label: t("footer.business.join_experts"), to: "#" }],
  };
  return (
    <footer
