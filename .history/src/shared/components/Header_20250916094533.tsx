  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between gap-4 px-4">
        ...
        {/* Search */}
        <div className="relative text-gray-600 flex-1 sm:max-w-md mx-auto max-md:hidden">
          <input
          ...
          >
            <SearchIcon className="w-4 h-4" key="search-visible" />
          </button>
        </div>
      ...
      <div className="mx-4">
        <div className="relative text-gray-600 flex-1 max-w-md mx-auto mt-3 md:hidden">
          <input
            className="border border-[#8A8A8A] w-full h-8 px-2 pr-10 rounded-lg text-sm focus:outline-none"
            type="search"
            name="search"
