    ...
    <>
      <div className="flex items-center gap-4 relative" ref={menuRef}>
        <p className="px-4 py-2 text-sm text-gray-700">
          اهلا بك
          {/* في الموبايل يظهر الاسم الأول */}
          <span className="font-medium ms-1 block sm:hidden">{firstName}</span>
          {/* في الشاشات الأكبر يظهر الاسم كامل */}
          <span className="font-medium ms-1 hidden sm:inline">{fullName}</span>
        </p>
        {/* User dropdown */}
