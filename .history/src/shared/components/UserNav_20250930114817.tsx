      ...
      <div className="relative">
        ...
        {open && (
          <div className="absolute end-0 mt-2 w-70 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
            <Link
              to={"my-profile"}
              className="block cursor-pointer w-10 h-10 bg-primary rounded-full mx-auto text-secondary font-bold center mt-4"
            >
              {firstName[0]} {middleName?.[0]}
            </Link>
            <div className="text-center mx-4 border-[#DBDBDB]">
              <Link to={"my-profile"} className="block font-semibold mt-2">
                {fullName}
              </Link>
