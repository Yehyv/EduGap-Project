    ...
    <>
      <div className="flex items-center gap-4 relative" ref={menuRef}>
        ...
        <div className="relative">
          ...
          {open && (
            <div className="absolute start-0 mt-2 w-40 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
              <button
                onClick={handleLogOut}
                className="w-full font-bold text-left px-4 py-2 text-sm text-red-500 hover:bg-gray-100"
              >
                {t("logout")}
              </button>
            </div>
