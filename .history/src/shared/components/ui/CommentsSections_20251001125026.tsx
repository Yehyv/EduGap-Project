...
const CommentsSection = () => {
  ...
  return (
    <>
      {/* Add Comment */}
      <div className="flex flex-col mb-4 border rounded-lg border-[#D6D6D6] p-3">
        ...
        <button
          onClick={addComment}
          className="bg-secondary  mt-3 text-white px-4 py-2 rounded hover:bg-secondary/90 cursor-pointer"
        >
          إضافة
        </button>
      </div>
