...
const CommentsSection = () => {
  ...
  return (
    <>
      ...
      <div className="mb-4 border rounded-lg border-[#D6D6D6] p-3 text-end">
        <div className="w-full flex gap-2">
          <div className="w-1/4 p-1 rounded-full bg-[#EDEDED]">
            <img src={UserImage} className="w-full h-12  object-contain" />
          </div>
          <div className="text-start">
            <h5>اسماء محمد</h5>
            <h6 className="text-[#939393] text-sm">منذ يومان</h6>
            <div className="text-start mt-2">
              "محتوى رائع بشكل عام. أتمنى أن يتم تناول موضوعات أكثر تقدمًا في
              الوحدات القادمة."
            </div>
          </div>
        </div>
