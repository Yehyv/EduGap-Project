...
const CommentsSection = () => {
  ...
  return (
    <>
      {/* Add Comment */}
      <div className="gap-2 mb-4 border rounded-lg border-[#D6D6D6] p-3">
        <div className="w-full flex gap-2">
          ...
          <input
            type="text"
            className="flex-1 w-full bg-[#EDEDED] min-h-40 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-secondary"
