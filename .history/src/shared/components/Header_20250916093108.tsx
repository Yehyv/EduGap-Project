  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between gap-4 px-4">
        ...
        {/* Search */}
        <div className="relative text-gray-600 flex-1 max-w-xs sm:max-w-md max-md:hidden">
          <input
      ...
      <div className="relative text-gray-600 flex-1 max-w-xs sm:max-w-md mx-auto mt-2">
        <input
          className="border border-[#8A8A8A] w-full h-7 px-2 pr-10 rounded-lg text-sm focus:outline-none"
          type="search"
          name="search"
          placeholder={t("search_placeholder")}
          dir={lang === "ar" ? "rtl" : "ltr"}
