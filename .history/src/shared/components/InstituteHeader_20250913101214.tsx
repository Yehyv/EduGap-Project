...
const InstituteHeader = () => {
  return (
    <div
      className="p-4 bg-gradient-to-r from-header-gradient-start to-header-gradient-end"
      dir="ltr"
    >
      <div className="relative container" dir="ltr">
        <h4 className="text-center text-[18px] max-md:text-sm">
          المعهد العالي للعلوم الإدارية - القطامية
        </h4>
        <img
          src={HIMSLogo}
          className="w-15 absolute end-4 top-1/2 -translate-y-1/2 max-md:w-10"
        ></img>
      </div>
    </div>
  );
