const translations = {
  en: {
    ...
    footer: {
      ...
      business: {
        title: "For Business",
        join_experts: "Join as an Expert",
      },
    },
  },
  ar: {
    ...
    popular: "الدورات الاكثر شيوعا",
    plans: "انظمة الاشتراك",
    footer_experts: "خبراء المنصة",
    //discover
    //business
    footer_title: "المنصة للأعمال",
    join_experts: "انضم لخبراء المنصة",
    //business
